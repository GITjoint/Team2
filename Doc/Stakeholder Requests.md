...
### 7.<a name="Надійність"> Надійність</a>
  ...
  Данні користувачів системи повинні бути захищені від сторонніх осіб шляхом введення аутентифікованого доступу (логін, пароль), шифрування (ssl сертифіката ) та регулярне резервне копіювання на фізичні носії.
